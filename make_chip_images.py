...
This is the best format for segmentation that matches 51
...
https://docs.voxel51.com/api/fiftyone.core.odm.dataset.html#fiftyone.core.odm.dataset.DatasetAppConfig
